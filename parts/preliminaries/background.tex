...
\begin{listing}[ht]
	...
	\caption[Example of move semantics in Rust.]{Type \code{Foo} is affine. On line~7, \code{x}~is moved into function \code{func}, consuming it. Accessing~$x$ is invalid, and so line~8 raises an error.}
	\label{listing:move}
\end{listing}
